...
import { X, Heart, ArrowLeft, ArrowRight, Check, Gift } from 'lucide-react';
...
export function DonationModal() {
  ...
  const tipAmount = numAmount * (tipPercent / 100);
        ...
        <div className="p-6">
          ...
          {step === 1 && (
            <div className="space-y-4">
              ...
              <Button
                className="w-full"
                disabled={!selectedAmount || numAmount <= 0}
                onClick={() => setStep(2)}
              >
                Continue
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <Checkbox
                  ...
                  onCheckedChange={(c) => setShowNamePublicly(!!c)}
                />
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl border border-primary/30 bg-primary/5 p-4">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  Optional contribution to help us keep the platform running
                </p>
                  ...
                  {[0, 5, 10].map((pct) => (
                    <button
                      ...
                      className={`flex-1 rounded-lg border py-1.5 text-xs font-medium transition-all ${
                        tipPercent === pct ? 'border-[var(--gold)] bg-[var(--gold)]/10 text-foreground' : 'border-border text-muted-foreground hover:border-border'
                      }`}
                    >
                      {pct}%
                    </button>
              ...
              <div className="rounded-lg bg-muted/50 p-3 text-xs text-muted-foreground space-y-1">
                ...
                <p className="text-muted-foreground/70 italic">Demo mode — no real payment will be processed</p>
              </div>
